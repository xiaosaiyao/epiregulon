...
// fast_chisq
Rcpp::List fast_chisq(Rcpp::IntegerVector peak_ordered, Rcpp::IntegerVector tf_by_peak, Rcpp::IntegerVector target_by_peak, Rcpp::IntegerVector target_ordered, int npeaks, Rcpp::NumericVector peakmat_x, Rcpp::LogicalVector peakmat_i, Rcpp::IntegerVector peakmat_p, double peak_cutoff, int ngenes, Rcpp::NumericVector expmat_x, Rcpp::LogicalVector expmat_i, Rcpp::IntegerVector expmat_p, double exp_cutoff, int nclusters, Rcpp::IntegerVector clusters);
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< Rcpp::LogicalVector >::type peakmat_i(peakmat_iSEXP);
    ...
    Rcpp::traits::input_parameter< Rcpp::LogicalVector >::type expmat_i(expmat_iSEXP);
