...
activity_matrix.norm <- activity_matrix/c(1,2,3,4,5)
...
# drop first column since all corresponding weights are zero
...
activity_matrix.center.norm <- activity_matrix.center/c(2,3,4,5)
