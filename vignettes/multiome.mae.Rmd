...
`logFC_condition`. If these are not provided, log fold changes are conducted for every condition in the cluster labels against the rest of the conditions.
...
regulon.w <- addLogFC(regulon = regulon.w,
                      ...
                      pval.type = "any",
                      logFC_condition = c("HTO10_GATA6_UTR", "HTO2_GATA6_v2", "HTO8_NKX2.1_UTR"),
